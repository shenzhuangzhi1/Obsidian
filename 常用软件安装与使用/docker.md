...
离线安装包下载地址：
- [bin包链接](https://download.docker.com/linux/static/stable/x86_64/)
- [rpm包链接](https://download.docker.com/linux/centos/7/x86_64/stable/Packages/)
...
```shell
# 修改配置添加该配置
ExecStart=/usr/bin/dockerd --graph=/inspur/data/docker
```
 #### [[#重新加载配置文件]]
